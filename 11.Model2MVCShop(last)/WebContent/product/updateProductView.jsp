	...
	<form class="update-product form-horizontal">
		<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" id="inputProdDetail" name="prodDetail" value="${product.prodDetail}" placeholder="상세정보">
				</div>
			</div>
			<br/>
			<div class="row">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-body">
									...
									<h4 class="modal-title" id="myModalLabel">잠시만 기다려주세요! 수정중입니다</h4>
								</div>
							</div>
						</div>
					</div>
