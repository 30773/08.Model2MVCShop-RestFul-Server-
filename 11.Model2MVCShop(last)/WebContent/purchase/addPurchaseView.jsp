...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('.add-purchase .btn-success:contains("구매")').on('click',function(){
				$('form').attr('method','post').attr('action','addPurchase').submit();
			});
			
			$('.add-purchase .btn-default:contains("취소")').on('click',function(){
				history.go(-1);
			});
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<br/>
					<div class="row">
						<label for="inputReceiverName" class="col-sm-3 control-label">수령자</label>
						<div class="col-sm-5">
					...
					<br/>
					<div class="row">
						<label for="inputDlvyDate" class="col-sm-3 control-label">희망하는 배송일</label>
						<div class="col-sm-5">
					...
					<br/>
					<div class="row">
						<label for="inputDlvyRequest" class="col-sm-3 control-label">요청할 사항</label>
						<div class="col-sm-8">
