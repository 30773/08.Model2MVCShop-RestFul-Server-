...
<head>
	...
	<script type="text/javascript">
		...
		function init(){
			...
			$('div.form-group[title="수정하려면 클릭하세요"] p').removeClass('hidden').off('click').on('click',function(){
		...
		$(function(){
			...
			$('.btn-primary:contains("정보수정")').on('click',function(){
				$.ajax({
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<form class="form-horizontal">
				...
				<div class="form-group" title="수정하려면 클릭하세요">
					<label class="col-sm-2 control-label">배송 희망일</label>
					<div class="col-sm-10">
